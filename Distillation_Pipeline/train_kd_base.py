...
def main():
    ...
    print(f"Loading Phase 1 Student from: {STUDENT_MODEL_B}...")
    ...
    args = TrainingArguments(
        output_dir=DISTILLED_OUTPUT_DIR_B,
    ...
    trainer.train()
    trainer.save_model(DISTILLED_OUTPUT_DIR_B)
    tokenizer.save_pretrained(DISTILLED_OUTPUT_DIR_B)
    print("Run complete.")
